...
class BluetoothSenderDistance extends StatefulWidget {
  const BluetoothSenderDistance({super.key});

  @override
  State<BluetoothSenderDistance> createState() => _BluetoothSenderScreenState();
}

class _BluetoothSenderScreenState extends State<BluetoothSenderDistance> {
  ...
  Future<void> _sendMessage() async {
    ...
    String result = await DistanceBLEService.sendBluetoothdistance(message);
